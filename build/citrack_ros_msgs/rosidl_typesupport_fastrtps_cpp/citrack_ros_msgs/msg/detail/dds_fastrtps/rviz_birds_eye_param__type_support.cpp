...
#include "citrack_ros_msgs/msg/detail/rviz_birds_eye_param__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const citrack_ros_msgs::msg::RvizBirdsEyeParam & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  citrack_ros_msgs::msg::RvizBirdsEyeParam & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_citrack_ros_msgs
max_serialized_size_RvizBirdsEyeParam(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = citrack_ros_msgs::msg::RvizBirdsEyeParam;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_citrack_ros_msgs
max_serialized_size_key_RvizBirdsEyeParam(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const citrack_ros_msgs::msg::RvizBirdsEyeParam *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<citrack_ros_msgs::msg::RvizBirdsEyeParam *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RvizBirdsEyeParam__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const citrack_ros_msgs::msg::RvizBirdsEyeParam *>(
...
static size_t _RvizBirdsEyeParam__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RvizBirdsEyeParam(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RvizBirdsEyeParam__callbacks = {
...
static rosidl_message_type_support_t _RvizBirdsEyeParam__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RvizBirdsEyeParam__callbacks,
...
{
  return &citrack_ros_msgs::msg::typesupport_fastrtps_cpp::_RvizBirdsEyeParam__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, citrack_ros_msgs, msg, RvizBirdsEyeParam)() {
  return &citrack_ros_msgs::msg::typesupport_fastrtps_cpp::_RvizBirdsEyeParam__handle;
}
