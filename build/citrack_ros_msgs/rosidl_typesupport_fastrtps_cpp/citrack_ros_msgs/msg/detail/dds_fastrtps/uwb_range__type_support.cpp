...
#include "citrack_ros_msgs/msg/detail/uwb_range__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const citrack_ros_msgs::msg::UwbRange & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  citrack_ros_msgs::msg::UwbRange & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = citrack_ros_msgs::msg::UwbRange;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_citrack_ros_msgs
max_serialized_size_key_UwbRange(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const citrack_ros_msgs::msg::UwbRange *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<citrack_ros_msgs::msg::UwbRange *>(
    untyped_ros_message);
...
{
  return &citrack_ros_msgs::msg::typesupport_fastrtps_cpp::_UwbRange__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, citrack_ros_msgs, msg, UwbRange)() {
  return &citrack_ros_msgs::msg::typesupport_fastrtps_cpp::_UwbRange__handle;
}
