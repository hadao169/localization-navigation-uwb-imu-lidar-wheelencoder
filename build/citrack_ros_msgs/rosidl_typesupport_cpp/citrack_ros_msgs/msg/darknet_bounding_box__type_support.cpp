...
static const _DarknetBoundingBox_type_support_symbol_names_t _DarknetBoundingBox_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, citrack_ros_msgs, msg, DarknetBoundingBox)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, citrack_ros_msgs, msg, DarknetBoundingBox)),
  }
};
...
{
  return &::citrack_ros_msgs::msg::rosidl_typesupport_cpp::DarknetBoundingBox_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, citrack_ros_msgs, msg, DarknetBoundingBox)() {
  return get_message_type_support_handle<citrack_ros_msgs::msg::DarknetBoundingBox>();
}
