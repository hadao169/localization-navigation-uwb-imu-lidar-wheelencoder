...
#include "citrack_ros_msgs/msg/detail/darknet_bounding_boxes__rosidl_typesupport_fastrtps_c.h"
...
#include "citrack_ros_msgs/msg/detail/darknet_bounding_box__functions.h"  // bounding_boxes
...
using _DarknetBoundingBoxes__ros_msg_type = citrack_ros_msgs__msg__DarknetBoundingBoxes;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: bounding_boxes
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_citrack_ros_msgs__msg__DarknetBoundingBox(
        &array_ptr[i], cdr);
    }
  }
  ...
  citrack_ros_msgs__msg__DarknetBoundingBoxes * ros_message)
{
  ...
  // Field name: bounding_boxes
  {
    ...
    if (ros_message->bounding_boxes.data) {
      citrack_ros_msgs__msg__DarknetBoundingBox__Sequence__fini(&ros_message->bounding_boxes);
    }
    ...
    auto array_ptr = ros_message->bounding_boxes.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_citrack_ros_msgs__msg__DarknetBoundingBox(cdr, &array_ptr[i]);
    }
  }
...
size_t get_serialized_size_citrack_ros_msgs__msg__DarknetBoundingBoxes(
  ...
  size_t current_alignment)
{
  const _DarknetBoundingBoxes__ros_msg_type * ros_message = static_cast<const _DarknetBoundingBoxes__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  // Field name: bounding_boxes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_citrack_ros_msgs__msg__DarknetBoundingBox(
  ...
  size_t current_alignment)
{
  ...
  // Field name: bounding_boxes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_citrack_ros_msgs__msg__DarknetBoundingBox(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = citrack_ros_msgs__msg__DarknetBoundingBoxes;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: bounding_boxes
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_citrack_ros_msgs__msg__DarknetBoundingBox(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: bounding_boxes
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_citrack_ros_msgs__msg__DarknetBoundingBox(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: bounding_boxes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_citrack_ros_msgs__msg__DarknetBoundingBox(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
static bool _DarknetBoundingBoxes__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const citrack_ros_msgs__msg__DarknetBoundingBoxes * ros_message = static_cast<const citrack_ros_msgs__msg__DarknetBoundingBoxes *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_citrack_ros_msgs__msg__DarknetBoundingBoxes(ros_message, cdr);
}

static bool _DarknetBoundingBoxes__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  citrack_ros_msgs__msg__DarknetBoundingBoxes * ros_message = static_cast<citrack_ros_msgs__msg__DarknetBoundingBoxes *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_citrack_ros_msgs__msg__DarknetBoundingBoxes(cdr, ros_message);
}

static uint32_t _DarknetBoundingBoxes__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_citrack_ros_msgs__msg__DarknetBoundingBoxes(
      untyped_ros_message, 0));
}

static size_t _DarknetBoundingBoxes__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_citrack_ros_msgs__msg__DarknetBoundingBoxes(
...
static message_type_support_callbacks_t __callbacks_DarknetBoundingBoxes = {
  "citrack_ros_msgs::msg",
  "DarknetBoundingBoxes",
  _DarknetBoundingBoxes__cdr_serialize,
  _DarknetBoundingBoxes__cdr_deserialize,
  _DarknetBoundingBoxes__get_serialized_size,
  _DarknetBoundingBoxes__max_serialized_size,
  nullptr
};

static rosidl_message_type_support_t _DarknetBoundingBoxes__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_DarknetBoundingBoxes,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, citrack_ros_msgs, msg, DarknetBoundingBoxes)() {
  return &_DarknetBoundingBoxes__type_support;
}
