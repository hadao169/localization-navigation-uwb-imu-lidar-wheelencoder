...
bool citrack_ros_msgs__msg__vicon_position__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("citrack_ros_msgs.msg._vicon_position.ViconPosition", full_classname_dest, 50) == 0);
  }
  citrack_ros_msgs__msg__ViconPosition * ros_message = _ros_message;
  {  // x_trans
...
{
  /* NOTE(esteve): Call constructor of ViconPosition */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("citrack_ros_msgs.msg._vicon_position");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ViconPosition");
